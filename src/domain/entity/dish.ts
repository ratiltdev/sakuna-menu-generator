...
export class Dish {
  ...
  private readonly foodCandidate: FoodName[];
  ...
  public get FoodCandidate(): FoodName[] { return this.foodCandidate; }
...
export const AllDishCategory: DishCategory[] = Object.values(DishCategory);
